...
/// `athena` — the Athena inference appliance: one unified CLI.
...
struct Athena: AsyncParsableCommand {
    ...
    static let appVersion = "0.10.271"

    static let configuration = CommandConfiguration(
        commandName: "athena",
        abstract:
            "Athena inference appliance (passive oracle).",
        ...
        subcommands: [
            ...
            Hf.self, Proxy.self,
            UsageCommand.self, AuditCommand.self,
            CacheCmd.self,
        ],
