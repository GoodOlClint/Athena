...
public class SortformerModel: Module {
    ...
    /// Load from a HuggingFace repo via Athena's governed downloader
    /// (HF_HOME SSD/local fallback from M4.1), not MLXAudioCore's
    /// ModelUtils — one download mechanism across the binary.
